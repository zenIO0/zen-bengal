deps_config := \
	...
	drivers/input/touchscreen/FT8719/Kconfig \
	drivers/input/touchscreen/NT36672A/Kconfig \
...
ifneq "$(CLANG_FLAGS)" " --target=aarch64-linux-gnu --prefix=/home/gitpod/toolchains/proton-clang/bin/aarch64-linux-gnu- --gcc-toolchain=/home/gitpod/toolchains/proton-clang -no-integrated-as  -Wno-misleading-indentation  -Wno-bool-operation -Werror=unknown-warning-option  -Wno-unsequenced"
include/config/auto.conf: FORCE
endif
ifneq "$(HOSTCXX)" "g++"
include/config/auto.conf: FORCE
